...
export const useTelegram = () => {
  const applyThemeClasses = () => {
    try {
      ...
      if (state.bgColor) root.style.setProperty('--tg-theme-bg-color', state.bgColor)
      if (state.textColor) root.style.setProperty('--tg-theme-text-color', state.textColor)
      if (state.hintColor) root.style.setProperty('--tg-theme-hint-color', state.hintColor)
      if (state.linkColor) root.style.setProperty('--tg-theme-link-color', state.linkColor)
      if (state.buttonColor) root.style.setProperty('--tg-theme-button-color', state.buttonColor)
      if (state.buttonTextColor) root.style.setProperty('--tg-theme-button-text-color', state.buttonTextColor)
      if (state.secondaryBgColor) root.style.setProperty('--tg-theme-secondary-bg-color', state.secondaryBgColor)
    } catch (error) {
