...
import { Box, Text, Badge, Stack, Card, Group, Divider } from '@mantine/core';
...
const BroadcastsList = () => {
    ...
    return (<Stack>
      ...
      <Stack gap="md">
        {items.map((broadcast) => (<Card key={broadcast.ID} shadow="sm" padding="md" radius="md" withBorder>
            ...
            <Group justify="space-between" align="flex-start" mb="sm">
              <Group gap="md">
                ...
                {broadcast.Language && (<Badge color="gray" variant="outline">
        ...
        {items.length === 0 && (<Card shadow="sm" padding="xl" radius="md" withBorder>
