    ...
    return (<Box>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Box mb="md">
          ...
          <SegmentedControl fullWidth data={typeOptions} value={type} onChange={(value) => {
            hapticFeedback.selectionChanged();
            setType(value);
        }}/>
        </Box>

        <Select label="Язык (необязательно)" placeholder="Все языки" data={availableLanguages.map(lang => ({ value: lang, label: lang.toUpperCase() }))} value={language} onChange={setLanguage} clearable mb="md"/>
